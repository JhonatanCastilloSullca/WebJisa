...
const BookNowSection = ({ tour }) => {
    ...
    const waHref = "51976294449"
        ? `https://wa.me/51976294449?text=${encodeURIComponent(msg)}`
                ...
                <div className="border-2 border-JisaGrisTextGray/10 bg-white rounded-b-md flex flex-col pb-2">
                    {isAvailable ? (
                        ...
                        <div className="px-6 py-6 flex flex-col items-center gap-4">
                            <p className="text-center text-JisaGrisTextGray">
                                {t("tours_detail.no_disponible")}
                            </p>
                            <a
                                href={waHref}
                                target="_blank"
                            ...
                            <p className="text-xs text-gray-400">
                                {t("tours_detail.ayuda_disponibilidad")}
                            </p>
                        </div>
                    )}
                </div>
